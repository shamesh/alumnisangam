...
abstract class BaseLoruserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'LorId', 'UserId', ),
		BasePeer::TYPE_COLNAME => array (LoruserPeer::ID, LoruserPeer::LOR_ID, LoruserPeer::USER_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'lor_id', 'user_id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'LorId' => 1, 'UserId' => 2, ),
		BasePeer::TYPE_COLNAME => array (LoruserPeer::ID => 0, LoruserPeer::LOR_ID => 1, LoruserPeer::USER_ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'lor_id' => 1, 'user_id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LoruserPeer::LOR_ID);
	...
	public static function doCountJoinLor(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
		...
		$criteria->addJoin(LoruserPeer::LOR_ID, LorPeer::ID);
	...
	public static function doSelectJoinLor(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		$c->addJoin(LoruserPeer::LOR_ID, LorPeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getLor(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		LorPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + LorPeer::NUM_COLUMNS;
	...
	public static function doCountJoinAllExceptLor(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptLor(Criteria $c, $con = null)
	{
		$c = clone $c;
