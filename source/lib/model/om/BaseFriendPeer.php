...
abstract class BaseFriendPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Friendid', 'Status', ),
		BasePeer::TYPE_COLNAME => array (FriendPeer::ID, FriendPeer::USER_ID, FriendPeer::FRIENDID, FriendPeer::STATUS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'friendid', 'status', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Friendid' => 2, 'Status' => 3, ),
		BasePeer::TYPE_COLNAME => array (FriendPeer::ID => 0, FriendPeer::USER_ID => 1, FriendPeer::FRIENDID => 2, FriendPeer::STATUS => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'friendid' => 2, 'status' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
