...
abstract class BaseBranchPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (BranchPeer::ID, BranchPeer::NAME, BranchPeer::CODE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (BranchPeer::ID => 0, BranchPeer::NAME => 1, BranchPeer::CODE => 2, ),
	...
	{
		include_once 'lib/model/map/BranchMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.BranchMapBuilder');
	}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Branch) {
	...
	public static function doValidate(Branch $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(BranchPeer::DATABASE_NAME, BranchPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = BranchPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/BranchMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.BranchMapBuilder');
}
