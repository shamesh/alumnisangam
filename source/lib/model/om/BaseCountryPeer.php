...
abstract class BaseCountryPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (CountryPeer::ID, CountryPeer::NAME, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (CountryPeer::ID => 0, CountryPeer::NAME => 1, ),
	...
	{
		include_once 'lib/model/map/CountryMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CountryMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CountryMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CountryMapBuilder');
}
