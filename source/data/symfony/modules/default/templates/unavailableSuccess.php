		...
		<div class="innerTop">
			<div class="header">
				...
				<div class="headerTopMenu">
						<ul>
							<li><a href="admin/login" class='rightSde_linkTxt'>Login</a></li>
							<li>|</li>
							<li><?php echo link_to('Buy','domain/domain');?></li>
							<li>|</li>
							<li><?php echo link_to('Sitemap','home/sitemap',array('class'=>'rightSde_linkTxt')) ?></li>	
						</ul>
				</div>
			</div>
			<div class="container" >
