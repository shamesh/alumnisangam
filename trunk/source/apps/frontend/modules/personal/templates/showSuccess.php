...
<?php if($glors): ?>
	<table cellspacing="3" cellpadding="3" style="margin-bottom: 20px; background-color: #cccccc">
	...
	<?php endforeach; ?>
	<tr style="background-color: #fff"><td colspan="3" align="right"><?php echo button_to('Reject All', '/personal/lorreject?a=g') ?></td></tr>
	</table>
<?php endif;*/ ?>
