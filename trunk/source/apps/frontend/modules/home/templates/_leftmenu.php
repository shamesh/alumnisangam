...
<div class="menuheader">Settings</div>
	...
	<div class="leftmenuitem"><a href="/stng/invites.html">Invitations</a></div>
...
<div class="menuheader">Communication</div>
	...
	<?php elseif( ($sf_user->hasCredential('auth')) || ($sf_user->hasCredential('masterauth'))): ?>
	<div class="menuheader">Authorization</div>	
		<div class="leftmenuitem"><?php echo link_to('Claimed Profile', 'user/pendinglist'); ?></div>
		<div class="leftmenuitem"><?php echo link_to('New Registration', 'user/newregister'); ?></div>
	<?php endif; ?>
<?php end_slot()?>
