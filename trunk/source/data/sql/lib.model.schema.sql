...
DROP TABLE IF EXISTS `chaptersandevents`;


CREATE TABLE `chaptersandevents`
(
	`id` INTEGER  NOT NULL AUTO_INCREMENT,
	`name` VARCHAR(50),
	`type` VARCHAR(10),
...
DROP TABLE IF EXISTS `careerResources`;


CREATE TABLE `careerResources`
(
	`id` INTEGER  NOT NULL AUTO_INCREMENT,
	`name` VARCHAR(50),
	PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `personal_worktype`;


CREATE TABLE `personal_worktype`
(
	`id` INTEGER  NOT NULL AUTO_INCREMENT,
	`personal_id` INTEGER,
	`worktype_id` INTEGER,
	PRIMARY KEY (`id`),
	INDEX `personal_worktype_FI_1` (`personal_id`),
	CONSTRAINT `personal_worktype_FK_1`
		FOREIGN KEY (`personal_id`)
		REFERENCES `personal` (`id`),
	INDEX `personal_worktype_FI_2` (`worktype_id`),
	CONSTRAINT `personal_worktype_FK_2`
