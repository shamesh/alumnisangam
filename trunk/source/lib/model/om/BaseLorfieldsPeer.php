...
abstract class BaseLorfieldsPeer {

	
	const DATABASE_NAME = 'propel';

	
	const TABLE_NAME = 'lorFields';

	
	const CLASS_DEFAULT = 'lib.model.Lorfields';
	...
	const ID = 'lorFields.ID';

	
	const FIELDS = 'lorFields.FIELDS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Fields', ),
		BasePeer::TYPE_COLNAME => array (LorfieldsPeer::ID, LorfieldsPeer::FIELDS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'fields', ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Fields' => 1, ),
		BasePeer::TYPE_COLNAME => array (LorfieldsPeer::ID => 0, LorfieldsPeer::FIELDS => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'fields' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		return str_replace(LorfieldsPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LorfieldsPeer::ID);

		$criteria->addSelectColumn(LorfieldsPeer::FIELDS);

	}

	const COUNT = 'COUNT(lorFields.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT lorFields.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(LorfieldsPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(LorfieldsPeer::COUNT);
		}
		...
		$rs = LorfieldsPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	public static function doSelectOne(Criteria $criteria, $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = LorfieldsPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return LorfieldsPeer::populateObjects(LorfieldsPeer::doSelectRS($criteria, $con));
	}
	...
	{
		return LorfieldsPeer::CLASS_DEFAULT;
	}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Lorfields) {
