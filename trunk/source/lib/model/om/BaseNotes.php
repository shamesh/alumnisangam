...
abstract class BaseNotes extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = NotesPeer::ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = NotesPeer::USER_ID;
		}
	...
	{
		$pos = NotesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = NotesPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NotesPeer::ID)) $criteria->add(NotesPeer::ID, $this->id);
		if ($this->isColumnModified(NotesPeer::USER_ID)) $criteria->add(NotesPeer::USER_ID, $this->user_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(NotesPeer::ID, $this->id);
