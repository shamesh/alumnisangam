...
abstract class BaseProfessionalPeer {
	...
	const FROM = 'professional.FROM';

	
	const TO = 'professional.TO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Employer', 'Employerflag', 'Position', 'Positionflag', 'From', 'To', ),
		BasePeer::TYPE_COLNAME => array (ProfessionalPeer::ID, ProfessionalPeer::USER_ID, ProfessionalPeer::EMPLOYER, ProfessionalPeer::EMPLOYERFLAG, ProfessionalPeer::POSITION, ProfessionalPeer::POSITIONFLAG, ProfessionalPeer::FROM, ProfessionalPeer::TO, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'employer', 'employerFlag', 'position', 'positionFlag', 'from', 'to', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Employer' => 2, 'Employerflag' => 3, 'Position' => 4, 'Positionflag' => 5, 'From' => 6, 'To' => 7, ),
		BasePeer::TYPE_COLNAME => array (ProfessionalPeer::ID => 0, ProfessionalPeer::USER_ID => 1, ProfessionalPeer::EMPLOYER => 2, ProfessionalPeer::EMPLOYERFLAG => 3, ProfessionalPeer::POSITION => 4, ProfessionalPeer::POSITIONFLAG => 5, ProfessionalPeer::FROM => 6, ProfessionalPeer::TO => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'employer' => 2, 'employerFlag' => 3, 'position' => 4, 'positionFlag' => 5, 'from' => 6, 'to' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProfessionalPeer::FROM);

		$criteria->addSelectColumn(ProfessionalPeer::TO);
