...
abstract class BasePersonalPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Image', 'Imageflag', 'Salutation', 'Firstname', 'Firstnameflag', 'Middlename', 'Middlenameflag', 'Lastname', 'Lastnameflag', 'Maidenname', 'Maidennameflag', 'Itbhuname', 'Itbhunameflag', 'Gender', 'Genderflag', 'Dob', 'Dobflag', 'Maritalstatus', 'Maritalstatusflag', 'Email', 'Emailflag', 'Website', 'Websiteflag', 'Linkedin', 'Linkedinflag', ),
